...
const glossaryParentGroupMap = new Map();
const groupAliasMap = new Map();
const rawMap = new Map();

rawMap.set("2PC", { title: "Two-Phase Commit", groups: ["commitment-protocol", "db"]});
rawMap.set("2PL", { title: "Two-Phase Locking", groups: ["commitment-protocol", "db", "concurrency"]});
rawMap.set("3PC", { title: "Three-Phase Commit", groups: ["commitment-protocol", "db"]});
...
rawMap.set("AmazonQLDB", { title: "Amazon Quantum Ledger Database", th: "Amazon QLDB", groups: ["aws", "db"], classes: [["skip", "nowrap"]]});
rawMap.set("AmazonRDS", { title: "Amazon Relational Database Service", th: "Amazon RDS", groups: ["aws", "db"], classes: [["skip", "nowrap"]]});
...
rawMap.set("AmazonDAX", { title: "Amazon DynamoDB Accelerator", th: "Amazon DAX", groups: ["aws", "db"], classes: ["nowrap"]});
...
rawMap.set("ARP", {title: "Address Resolution Protocol", groups: ["communication-protocol"]});
...
rawMap.set("BLOB", {title: "Binary Large Object", groups: ["db"]});
...
rawMap.set("CAP", {title: "Consistency | Availability | Partition tolerance", groups: ["db"]});
...
rawMap.set("CRUD", {title: "Create Read Update Delete", groups: ["db"]});
...
rawMap.set("SSRF", {title: "Server-Side Request Forgery", groups: ["vulnerability"]});
...
rawMap.set("DBMS", {title: "DataBase Management System", groups: ["db"]});
...
rawMap.set("FDD", {title: "Floppy Disk Drive", groups: ["persistence"]});
rawMap.set("FPGA", {title: "Field-Programmable Gate Array", groups: []});
rawMap.set("FQDN", {title: "Fully Qualified Domain Name", groups: [], notes: "#DNS"});
rawMap.set("FTP", {title: "File Transfer Protocol", groups: ["communication-protocol"]});
...
rawMap.set("GPU", {title: "Graphics Processing Unit", groups: ["processor"]});
...
rawMap.set("HITECH", {title: "Health Information Technology for Economic and Clinical Health Act", groups: ["GDPR"]});
rawMap.set("HCMS", {title: "Headless Content Management System", groups: ["CMS"]});
rawMap.set("HDD", {title: "Hard Disk Drive", groups: ["persistence"]});
...
rawMap.set("HTTP", {title: "Hypertext Transfer Protocol", groups: ["communication-protocol"], notes: "Stateless", svg: "http"});
rawMap.set("HTTPS", {title: "Hypertext Transfer Protocol Secure", groups: ["communication-protocol"], notes: "Stateless"});
...
rawMap.set("ICMP", {title: "Internet Control Message Protocol", groups: ["communication-protocol"], notes: "#PING"});
...
rawMap.set("IGMP", {title: "Internet Group Management Protocol", groups: ["communication-protocol"]});
...
rawMap.set("IP", {title: "Internet Protocol", groups: ["communication-protocol"], notes: "#CIDR"});
...
rawMap.set("LDAP", {title: "Lightweight Directory Access Protocol", groups: ["communication-protocol"]});
...
rawMap.set("NFC", {title: "Near-Field Communication", groups: ["communication-protocol"]});
...
rawMap.set("NNTP", {title: "Network News Transport Protocol", groups: ["communication-protocol"]});
...
rawMap.set("OSS", {title: "Open Source Software", groups: ["software"]});
rawMap.set("ORCID", {title: "Open Researcher and Contributor ID", groups: []});
...
rawMap.set("PC", {title: "Personal Computer", groups: ["computer"]});
rawMap.set("PCI", {title: "Peripheral Component Interconnect", groups: ["bus"]});
...
rawMap.set("PL/SQL", {title: "Procedural Language / #SQL", groups: ["sql"]});
...
rawMap.set("ROM", {title: "Read Only Memory", groups: ["memory"]});
...
rawMap.set("RAG", {title: "Retrieval-Augmented Generation", groups: ["ai"]});
rawMap.set("RDNN", {title: "Reverse domain name notation", groups: ["java", "notation"]});
rawMap.set("RoI", {title: "Return on Investment", groups: ["financial-metric"]});
rawMap.set("RoR", {title: "Rate of Return", groups: ["financial-metric"]});
rawMap.set("RoR1", {title: "Return on Revenue", th:"RoR", groups: ["financial-metric"], notes: "Net Profit Margin"});
...
rawMap.set("SCS", {title: "Source Control Systems", groups: ["version-control"], notes: "The same as #VCS"});
rawMap.set("SRPP", {title: "Secure Remote Password Protocol", groups: ["protocol", "security"]});

rawMap.set("TX", {title: "Transaction", groups: ["tx", "db-tx"]});
rawMap.set("TCL", {title: "Transaction Control Language", groups: ["sql", "db-tx"]});
rawMap.set("TCP-IP", {title: "Transmission Control Protocol / Internet Protocol", groups: ["communication-protocol"], notes: "Includes: #IP #HTTP #HTTPS #FTP #DNS #SMTP #UDP"});
...
rawMap.set("UDP", {title: "User Datagram Protocol", groups: ["communication-protocol"]});
...
rawMap.set("USB", {title: "Universal Serial Bus", groups: ["bus"]});
rawMap.set("UTF", {title: "Unicode Transformation Format", groups: ["format"]});

rawMap.set("VGA", {title: "Video Graphics Array", groups: ["video"], notes: "640 × 480"});
...
rawMap.set("VCF", {title: "Virtual Contact File", groups: ["format"], notes : "vCard"});
...
// Parent group should be declared first!
glossaryGroupMap.set("ml", {text: "#GML -> #SGML -> [ #XML , #HTML -> #XHTML ]; #DTD"});
glossaryGroupMap.set("aaS", {text: "[ #SaaS [ #PaaS #CaaS [ #Iaas ]]]"});
